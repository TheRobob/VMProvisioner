          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              ...
              <div class="bottom-border pb-3">
                <img src="images/administrator-xxl.png" width="50" class="rounded-circle mr-3">
                <a href="#" class="text-white"><?php echo $_SESSION['username']?> </a>
              </div>
              <ul class="navbar-nav flex-column mt-4">
                <li class="nav-item"><a href="admindashboard.php" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-home text-light fa-lg mr-3"></i>Dashboard</a></li>
              </ul>
            </div>
            <!-- end of sidebar -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <textarea class="form-control" id="admincomments" placeholder="Admin Comments"></textarea><br>
            <label for="vmstatus">Status:</label>
            <select class="form-control" id="vmstatus">
              <option selected>Requested</option>
              <option>Approved</option>
              <option>Approved-Ammended</option>
