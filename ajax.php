    ...
    //Creating Database Connection
        ...
        if (isset($_POST['key'])){
            ...
            if ($_POST['key'] == 'populatetable'){
                ...
                $sql = $conn->query("SELECT id, vmname, username, vmvcpu, vmmem, vmdisk, vmstatus, time FROM vm LIMIT $start, $limit");
                if($sql->num_rows > 0){
                    $response = "";
            ...
            $admincomments = $conn->real_escape_string($_POST['admincomments']);
            $vmstatus = $conn->real_escape_string($_POST['vmstatus']);
            ...
            if ($_POST['key'] == 'addnew') {
                ...
                if($sql->num_rows > 0){
                    ...
                    VALUES ('$vmname', '$username', '$vmvcpu', '$vmmem', '$vmdisk', '$notes','$admincomments', '$command', '$vmstatus')");
